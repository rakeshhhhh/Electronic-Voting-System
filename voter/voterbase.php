...
<html lang="en">
<head>
<title>Eletronic Voting System/Voter<</title>
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse justify-content-center pr-md-4" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item">
							<a class="nav-link active" href="voterhome.php">Home <span class="sr-only">(current)</span></a>
						</li>
						
						<li class="nav-item">
							<a class="nav-link" href="viewelection.php">Election Details</a>
							<li class="nav-item">
							<!-- <a class="nav-link" href="viewcandi.php">Candidate list</a> -->
						<!-- </li>
                                                <li class="nav-item">
							<a class="nav-link" href="voting.php">Voting</a>
						</li> -->
                                                <li class="nav-item">
							<!-- <a class="nav-link" href="../voter/result.php">Winner</a> -->
						</li>
